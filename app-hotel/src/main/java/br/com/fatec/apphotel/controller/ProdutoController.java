...
/**
 * Classe reesponsável por conter os endpoints referente ao Produto
 *
 * @author Kim Tsunoda
 * @since 20/11/2020
 */
...
public class ProdutoController {
     ...
     */
    @PostMapping
    public ResponseEntity<ProdutoDTO> cadastrarHospede ( @RequestBody @Valid ProdutoEntrypointRequest produtoRequest ,
